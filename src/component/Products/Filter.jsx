...
//           <div className='flex items-baseline justify-betweenpb-6 mt-10'>
...
import Product from '../../pages/Product'
import { useCategories } from '../../context/CategoriesContext'
import { useProducts } from '../../context/ProductContext' // Import useProducts to access setCategory
...
export default function App() {
  ...
  const { setCategory } = useProducts() // Destructure setCategory from the ProductContext

  const handleCategoryChange = (categoryId) => {
    console.log('Selected Category ID:', categoryId)
    setCategory(categoryId) // Update the category ID in the context
  }
